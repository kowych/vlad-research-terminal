...
insert into sources (slug, name, tier, source_type, base_url, license_note) values
  ...
  ('bank-of-canada-valet-fx', 'Bank of Canada Valet · Daily FX Rates', 1, 'official', 'https://www.bankofcanada.ca/valet/docs/', 'Public daily indicative reference rates. Raw CAD quotations and the USD cross-rate calculation are retained per observation.'),
  ('national-bank-ukraine-fx', 'National Bank of Ukraine · Official FX Rate', 1, 'official', 'https://bank.gov.ua/en/markets/exchangerates', 'Official UAH/USD reference rate. It is labelled as a reference rate, not an executable market quote.'),
  ('bank-of-russia-fx', 'Bank of Russia · Official FX Rate', 1, 'official', 'https://www.cbr.ru/eng/currency_base/daily/', 'Official RUB/USD reference rate. It is labelled as a reference rate, not an executable market quote.'),
...
insert into indicators (slug, name, category, unit, frequency) values
  ...
  ('fx-usd', 'Exchange Rate vs US Dollar', 'market', 'USD per local currency', 'daily'),
